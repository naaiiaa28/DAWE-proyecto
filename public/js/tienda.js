...
export const productos = [
    // Novelas
    new Novela('Cien años de soledad', 18.50, 'Obra maestra de García Márquez sobre la familia Buendía', null, 'Gabriel García Márquez'),
    new Novela('1984', 15.99, 'Distopía clásica de George Orwell', null, 'George Orwell'),
    new Novela('El Quijote', 22.00, 'La obra cumbre de Cervantes', null, 'Miguel de Cervantes'),

    // Ciencia Ficción
    new CienciaFiccion('Dune', 24.99, 'Épica espacial de Frank Herbert', null, 'Frank Herbert'),
    new CienciaFiccion('Fundación', 19.50, 'Primera entrega de la saga de Asimov', null, 'Isaac Asimov'),
    new CienciaFiccion('Neuromante', 17.99, 'Cyberpunk clásico de William Gibson', null, 'William Gibson'),

    // Ensayos
    new Ensayo('Sapiens', 21.90, 'De animales a dioses: Una breve historia de la humanidad', null, 'Editorial Debate'),
    new Ensayo('El mundo y sus demonios', 16.50, 'Carl Sagan sobre el pensamiento crítico', null, 'Planeta'),
    new Ensayo('Pensar rápido, pensar despacio', 19.99, 'Daniel Kahneman sobre la toma de decisiones', null, 'Debate'),

    // Infantiles
    new Infantil('El Principito', 12.50, 'Clásico de Antoine de Saint-Exupéry', null, '8+ años'),
    new Infantil('Matilda', 14.99, 'Historia de Roald Dahl sobre una niña prodigio', null, '7+ años'),
    new Infantil('Harry Potter y la Piedra Filosofal', 16.95, 'Primera aventura del joven mago', null, '9+ años'),

    // Cómics
    new Comic('Watchmen', 29.99, 'Obra maestra del cómic de Alan Moore', null, 'Dave Gibbons'),
    new Comic('Maus', 24.50, 'Novela gráfica ganadora del Pulitzer', null, 'Art Spiegelman'),
    new Comic('V de Vendetta', 26.00, 'Thriller político de Alan Moore', null, 'David Lloyd')
];
